...
import { TopicCntArrVal, TopicSizeArrVal } from "@/types/getQTProp";
...
function GrpModal({
  ...
  const fetchTableData = async () => {
    try {
      const bodyData = {
        case_method: "ALL_GET",
        rawTopicSn: propInfo.raw_topic_sn,
      };
      ...
      const cntArr = TopicCntArrVal;
      const sizeArr = TopicSizeArrVal;
      // const numArr = TopicNumArrVal;
